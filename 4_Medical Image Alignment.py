"""
这是我个人根据医学影像配准原理写的配准的python代码，用的插值方法是线性插值，可以实现将多个序列配准到同一个序列，
在配准的过程中，可能会出现个别图像由于格式比较奇特，使用这个代码配准出现报错的情况，这种情况很少出现，如果出现的话，可以使用itk-snap软件手动进行配准，
itk-snap的配准教程我也写了相关教程，上链接：https://blog.csdn.net/qq_43449643/article/details/132005951
"""
